package ru.clevertec.logging.builder.impl;

import lombok.AllArgsConstructor;
import lombok.NoArgsConstructor;
import lombok.With;
import ru.clevertec.logging.builder.TestBuilder;
...
public class NewsTestBuilder implements TestBuilder<News> {
    ...
    private List<Comment> comments = List.of(
            ...
            //          new Comment(2L, "Vasya", "Cool", LocalDateTime.now(), LocalDateTime.now(), NewsTestBuilder.aNews().build()),
//            new Comment(3L, "Alla", "Yay", LocalDateTime.now(), LocalDateTime.now(), NewsTestBuilder.aNews().build())
    );
